...
import { faArrowRight, faBed, faChair, faDumbbell, faHeartPulse } from '@fortawesome/free-solid-svg-icons'
...
function formatHabitValue(value: string | null | undefined) {
        ...
        <>
          <div className="mp-habit-list">
            <div className="mp-habit-row">
              ...
              <span className="mp-habit-value">{formatHabitValue(habitData.sitting_hours_per_day)}</span>
            </div>
            <div className="mp-habit-row">
              <div className="mp-habit-icon"><FontAwesomeIcon icon={faDumbbell} /></div>
              <span className="mp-habit-label">주간 운동 일수</span>
              <span className="mp-habit-value">{formatHabitValue(habitData.exercise_days_per_week)}</span>
            </div>
            <div className="mp-habit-row">
              <div className="mp-habit-icon"><FontAwesomeIcon icon={faHeartPulse} /></div>
              <span className="mp-habit-label">불편한 부위</span>
              <span className="mp-habit-value">{formatHabitValue(habitData.pain_areas)}</span>
            </div>
            <div className="mp-habit-row">
              <div className="mp-habit-icon"><FontAwesomeIcon icon={faBed} /></div>
              <span className="mp-habit-label">수면 자세</span>
              <span className="mp-habit-value">{formatHabitValue(habitData.sleep_position)}</span>
            </div>
          </div>
          <div className="mp-habit-footer">
            <button className="btn--tonal" onClick={onRetakeHabits}>
              다시 입력하기 <FontAwesomeIcon icon={faArrowRight} />
            </button>
          </div>
        </>
      )}
