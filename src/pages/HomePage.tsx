...
const formatRecentAnalysisDate = (value?: string | null) => {
...
export default function HomePage() {
  ...
  const latestScore = typeof data?.posture_score === 'number' && Number.isFinite(data.posture_score)
      ...
      : 0
  const scoreStyle = { '--score': latestScore } as CSSProperties
      ...
      <main>
        ...
        <div className="home-page">
          ...
          {isError && (
              <section className={'my-info'}>
                <div className={'my-info-text'}>
                  <h3>아직 기록이 없어요!<br />새로 측정해볼까요?</h3>
                  <div className='my-info-actions'>
                    <Link className='my-info-actions__btn my-info-actions__btn--primary' to='/photo'>
                      지금 사진 올리기
                    </Link>
                    <Link className='my-info-actions__btn my-info-actions__btn--secondary' to='/webcam'>
                      웹캠 분석 →
                    </Link>
                  </div>
                </div>
          ...
          {!isLoading && !isError && data && (
              <section className='my-info'>
                <div className='my-info-score' style={scoreStyle}>
                  ...
                  <div className='my-info-score__inner'>
                    <strong className='my-info-score__value' >{latestScore}</strong>
                ...
                <div className='my-info-text'>
                  ...
                  <p>최근 기록은 <b>{latestDateLabel}</b>. <br /> {data.ai_message}</p>
                  <div className='my-info-actions'>
                    <Link className='my-info-actions__btn my-info-actions__btn--primary' to='/photo'>
                      지금 사진 올리기
                    </Link>
